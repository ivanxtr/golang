...
// TrasnferTxParams contains the input parameters of the transfer transaction
type TrasnferTxParams struct {
...
func (store *Store) TransferTx(ctx context.Context, arg TrasnferTxParams) (TransferTxResult, error) {
